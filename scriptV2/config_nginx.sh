...
export NGINX_TEMP="$NGINX_BASE_PATH/temp"
export NGINX_CLIENT_BODY_TEMP_PATH="$NGINX_TEMP/client_body"
export NGINX_PROXY_TEMP_PATH="$NGINX_TEMP/proxy"
export NGINX_FASTCGI_TEMP_PATH="$NGINX_TEMP/fastcgi"
export NGINX_UWSGI_TEMP_PATH="$NGINX_TEMP/uwsgi"
export NGINX_SCGI_TEMP_PATH="$NGINX_TEMP/scgi"

create_dir "$NGINX_BASE_PATH"
create_dir "$NGINX_CONF_D_PATH"
create_dir "$NGINX_TEMP"
create_dir "$NGINX_CLIENT_BODY_TEMP_PATH"
create_dir "$NGINX_PROXY_TEMP_PATH"
create_dir "$NGINX_FASTCGI_TEMP_PATH"
create_dir "$NGINX_UWSGI_TEMP_PATH"
create_dir "$NGINX_SCGI_TEMP_PATH"
